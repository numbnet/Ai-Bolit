...
echo "###################################"
aibolit\php70_64\php.exe -d short_open_tag=on site\aibolit_temp.php --mode=2 --report=..\AI-BOLIT-REPORT.html
...
echo "###################################"
aibolit\php70_32\php.exe -d short_open_tag=on site\aibolit_temp.php --mode=2 --report=..\AI-BOLIT-REPORT.html
